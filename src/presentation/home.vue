    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="bg-white py-12">
            <div class="max-w-7xl mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        <div class="text-4xl font-bold text-indigo-600 mb-2">{{ cityStore.cities.length }}</div>
                        <div class="text-gray-600">Cities to Explore</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold text-indigo-600 mb-2">
                            {{new Set(cityStore.cities.map(city => city.country)).size}}
                        </div>
        ...
        <div class="py-16 px-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div v-if="cityStore.loading" class="text-center p-12">
                    <div
                ...
                <div v-else-if="cityStore.error" class="text-center p-12 bg-red-50 rounded-lg">
                    <p class="text-red-600">{{ cityStore.error }}</p>
